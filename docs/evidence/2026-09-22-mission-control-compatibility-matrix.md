  ...
  "clients": [
    {
      ...
      "stages": {
        ...
        "invocation": {
          ...
          "evidence": "Ran 5 command(s); exit status 0, 0, 0, 0, 0. The client's output named the package name."
        }
      },
      "status": "works-directly",
      "reason": "All four stages ran through this client and every command exited 0: placement, discovery, load, and invocation of 5 declared entrypoint(s) from the path this client resolved."
    },
    {
      "name": "OpenAI Codex",
      "version": "0.155.1",
      ...
      "stages": {
        "placement": {
          ...
          "commands": [
            ...
            {
              "command": "cp -R <package>/skills/triage <client-home>/.agents/skills/",
              "exit_status": 0
            }
          ],
          "evidence": "Ran 8 command(s); exit status 0, 0, 0, 0, 0, 0, 0, 0. The command produced no output, so its exit status is the whole result."
        },
        "discovery": {
          "result": "executed",
          ...
          "evidence": "Ran 1 command(s); exit status 1. The client reported the subcommand this stage uses as unknown. The client's output named 0 of 8 declared skill unit(s)."
        },
        "load": {
          "result": "executed",
          "command": "opencode debug skill",
      ...
      "stages": {
        "placement": {
          ...
          "commands": [
            ...
            {
              "command": "muse skills install <package>/skills/triage --scope user",
              "exit_status": 0
            }
          ],
          "evidence": "Ran 8 command(s); exit status 0, 0, 0, 0, 0, 0, 0, 0. The client's output named 8 of 8 declared skill unit(s)."
        },
        "discovery": {
          "result": "executed",
        ...
        "load": {
          ...
          "commands": [
            ...
            {
              "command": "muse skills install <package>/skills/triage --scope user --force --json",
              "exit_status": 0
            }
          ],
          "evidence": "Ran 8 command(s); exit status 0, 0, 0, 0, 0, 0, 0, 0. The client's output named 8 of 8 declared skill unit(s)."
      ...
      "stages": {
        "placement": {
          ...
          "commands": [
            ...
            {
              "command": "cp -R <package>/skills/triage <client-home>/.hermes/skills/",
              "exit_status": 0
            }
          ],
          "evidence": "Ran 8 command(s); exit status 0, 0, 0, 0, 0, 0, 0, 0. The command produced no output, so its exit status is the whole result."
