...
# Ten-client compatibility matrix — portable unifi package (2.0.7)

This repository holds the portable source catalog for Infiquetra Agent Skills
and Agent Plugins. `plugins/unifi/` is authored and maintained
here. This document records what happened when the shipped package —
29 files, tree `94d5997ad1dd3505bf8a4f7806708308ace00c1154df48137e05a1a1232b70c2` — was put in front
...
- **Isolation.** Each client was handed its own fresh copy of the shipped tree, at 29 files, fingerprinted before and after that client ran. Every copy was unchanged afterwards, so no client added a vendor artifact to the package. Nine clients ran against
...
- **Credentials.** The harness removed every variable matching `UNIFI_` from every subprocess environment before each stage. Nine clients ran unauthenticated in their own empty scratch homes. Cursor Agent ran against the operator's real authenticated home by design, because an isolated home strips its authentication and produces a false failure; its authentication state is recorded only as present. No credential was created, changed, or read into this evidence, and no account identity is published here.
...
```json
{
  ...
  "package": {
    ...
    "version": "2.0.7",
    "file_count": 29,
    "tree_sha256": "94d5997ad1dd3505bf8a4f7806708308ace00c1154df48137e05a1a1232b70c2"
  },
  "method": {
    "stages": [
      "placement",
    ...
    "isolation": "Each client was handed its own fresh copy of the shipped tree, at 29 files, fingerprinted before and after that client ran. Every copy was unchanged afterwards, so no client added a vendor artifact to the package.",
    "credentials": "The harness removed every variable matching `UNIFI_` from every subprocess environment before each stage. Nine clients ran unauthenticated in their own empty scratch homes. Cursor Agent ran against the operator's real authenticated home by design, because an isolated home strips its authentication and produces a false failure; its authentication state is recorded only as present. No credential was created, changed, or read into this evidence, and no account identity is published here.",
    "network": "The invocation stage runs each declared entrypoint's credential-free `--help` action, which parses arguments and exits without a network call. The other three stages run each client's own commands, so a client that reaches its own service does so on its own account; Cursor Agent's three stages are model prompts, which is why it is the one client assessed against the real authenticated home."
  },
  "clients": [
    {
      ...
      "stages": {
        "placement": {
          ...
          "evidence": "Ran 1 command(s); exit status 0. The client's output named the package name, version 2.0.7, 0 of 2 declared skill unit(s)."
        },
        "discovery": {
          "result": "executed",
          "command": "claude --plugin-dir <package> plugin list",
        ...
        "load": {
          ...
          "evidence": "Ran 1 command(s); exit status 0. The client's output named the package name, version 2.0.7, 2 of 2 declared skill unit(s)."
        },
        "invocation": {
          "result": "executed",
          "command": "<python> <package>/skills/unifi-network/scripts/unifi_network_client.py --help",
          "commands": [
            {
              "command": "<python> <package>/skills/unifi-network/scripts/unifi_network_client.py --help",
              "exit_status": 0
            ...
            {
              "command": "<python> <package>/skills/unifi-protect/scripts/unifi_protect_client.py --help",
              "exit_status": 0
            }
          ],
          "evidence": "Ran 2 command(s); exit status 0, 0. The client's output named the package name."
        }
      },
    ...
    },
    {
      ...
      "stages": {
        "placement": {
          ...
          "evidence": "Ran 1 command(s); exit status 1. The client refused the package root and named the manifest it requires. The client's output named the package name, 0 of 2 declared skill unit(s)."
        },
        "discovery": {
          "result": "executed",
          ...
          "evidence": "Ran 1 command(s); exit status 0. The client's output named 0 of 2 declared skill unit(s)."
        },
        "load": {
          "result": "blocked",
    ...
    },
    {
      ...
      "stages": {
        "placement": {
          ...
          "evidence": "Ran 1 command(s); exit status 0. The client's output named the package name, 2 of 2 declared skill unit(s)."
        },
        "discovery": {
          "result": "executed",
        ...
        "invocation": {
          "result": "executed",
          "command": "<python> <client-home>/.qwen/extensions/unifi/skills/unifi-network/scripts/unifi_network_client.py --help",
          "commands": [
            {
              "command": "<python> <client-home>/.qwen/extensions/unifi/skills/unifi-network/scripts/unifi_network_client.py --help",
              "exit_status": 0
            ...
            {
              "command": "<python> <client-home>/.qwen/extensions/unifi/skills/unifi-protect/scripts/unifi_protect_client.py --help",
              "exit_status": 0
            }
          ],
          "evidence": "Ran 2 command(s); exit status 0, 0. The client's output named the package name."
    ...
    },
    {
      ...
      "stages": {
        "placement": {
          ...
          "evidence": "Ran 1 command(s); exit status 0. The client's output named the package name, 0 of 2 declared skill unit(s)."
        },
        "discovery": {
          "result": "executed",
        ...
        "invocation": {
          "result": "blocked",
          "command": "<python> <client-home>/.grok/installed-plugins/<plugin-id>/skills/unifi-network/scripts/unifi_network_client.py --help",
    ...
    },
    {
      ...
      "stages": {
        "placement": {
          "result": "executed",
          "command": "cp -R <package>/skills/unifi-network <client-home>/.agents/skills/",
          "commands": [
            {
              "command": "cp -R <package>/skills/unifi-network <client-home>/.agents/skills/",
              "exit_status": 0
            ...
            {
              "command": "cp -R <package>/skills/unifi-protect <client-home>/.agents/skills/",
              "exit_status": 0
            }
          ],
          "evidence": "Ran 2 command(s); exit status 0, 0. The command produced no output, so its exit status is the whole result."
        },
        "discovery": {
          "result": "executed",
          ...
          "evidence": "Ran 1 command(s); exit status 1. The client reported the subcommand this stage uses as unknown. The client's output named 0 of 2 declared skill unit(s)."
        },
        "load": {
          "result": "executed",
          "command": "opencode debug skill",
        ...
        "invocation": {
          "result": "executed",
          "command": "<python> <client-home>/.agents/skills/unifi-network/scripts/unifi_network_client.py --help",
          "commands": [
            {
              "command": "<python> <client-home>/.agents/skills/unifi-network/scripts/unifi_network_client.py --help",
              "exit_status": 0
            ...
            {
              "command": "<python> <client-home>/.agents/skills/unifi-protect/scripts/unifi_protect_client.py --help",
              "exit_status": 0
            }
          ],
          "evidence": "Ran 2 command(s); exit status 0, 0. The client's output named the package name."
    ...
    },
    {
      ...
      "stages": {
        "placement": {
          "result": "executed",
          "command": "gemini skills link <package>/skills/unifi-network",
          "commands": [
            {
              "command": "gemini skills link <package>/skills/unifi-network",
              "exit_status": 0
            ...
            {
              "command": "gemini skills link <package>/skills/unifi-protect",
              "exit_status": 0
            }
          ],
          "evidence": "Ran 2 command(s); exit status 0, 0. The client's output named the package name, 2 of 2 declared skill unit(s)."
        },
        "discovery": {
          "result": "executed",
        ...
        "invocation": {
          "result": "executed",
          "command": "<python> <client-home>/.gemini/skills/unifi-network/scripts/unifi_network_client.py --help",
          "commands": [
            {
              "command": "<python> <client-home>/.gemini/skills/unifi-network/scripts/unifi_network_client.py --help",
              "exit_status": 0
            ...
            {
              "command": "<python> <client-home>/.gemini/skills/unifi-protect/scripts/unifi_protect_client.py --help",
              "exit_status": 0
            }
          ],
          "evidence": "Ran 2 command(s); exit status 0, 0. The client's output named the package name."
    ...
    },
    {
      ...
      "stages": {
        "placement": {
          "result": "executed",
          "command": "muse skills install <package>/skills/unifi-network --scope user",
          "commands": [
            {
              "command": "muse skills install <package>/skills/unifi-network --scope user",
              "exit_status": 0
            ...
            {
              "command": "muse skills install <package>/skills/unifi-protect --scope user",
              "exit_status": 0
            }
          ],
          "evidence": "Ran 2 command(s); exit status 0, 0. The client's output named the package name, 2 of 2 declared skill unit(s)."
        ...
        "load": {
          "result": "executed",
          "command": "muse skills install <package>/skills/unifi-network --scope user --force --json",
          "commands": [
            {
              "command": "muse skills install <package>/skills/unifi-network --scope user --force --json",
              "exit_status": 0
            ...
            {
              "command": "muse skills install <package>/skills/unifi-protect --scope user --force --json",
              "exit_status": 0
            }
          ],
          "evidence": "Ran 2 command(s); exit status 0, 0. The client's output named the package name, 2 of 2 declared skill unit(s)."
        ...
        "invocation": {
          "result": "executed",
          "command": "<python> <client-home>/.config/muse/skills/unifi-network/scripts/unifi_network_client.py --help",
          "commands": [
            {
              "command": "<python> <client-home>/.config/muse/skills/unifi-network/scripts/unifi_network_client.py --help",
              "exit_status": 0
            ...
            {
              "command": "<python> <client-home>/.config/muse/skills/unifi-protect/scripts/unifi_protect_client.py --help",
              "exit_status": 0
            }
          ],
          "evidence": "Ran 2 command(s); exit status 0, 0. The client's output named the package name."
    ...
    },
    {
      ...
      "stages": {
        ...
        "invocation": {
          "result": "executed",
          "command": "<python> <client-home>/.gemini/config/plugins/unifi/skills/unifi-network/scripts/unifi_network_client.py --help",
          "commands": [
            {
              "command": "<python> <client-home>/.gemini/config/plugins/unifi/skills/unifi-network/scripts/unifi_network_client.py --help",
              "exit_status": 0
            ...
            {
              "command": "<python> <client-home>/.gemini/config/plugins/unifi/skills/unifi-protect/scripts/unifi_protect_client.py --help",
              "exit_status": 0
            }
          ],
          "evidence": "Ran 2 command(s); exit status 0, 0. The client's output named the package name."
    ...
    },
    {
      ...
      "stages": {
        "placement": {
          "result": "executed",
          "command": "cp -R <package>/skills/unifi-network <client-home>/.hermes/skills/",
          "commands": [
            {
              "command": "cp -R <package>/skills/unifi-network <client-home>/.hermes/skills/",
              "exit_status": 0
            ...
            {
              "command": "cp -R <package>/skills/unifi-protect <client-home>/.hermes/skills/",
              "exit_status": 0
            }
          ],
          "evidence": "Ran 2 command(s); exit status 0, 0. The command produced no output, so its exit status is the whole result."
        ...
        "invocation": {
          "result": "executed",
          "command": "<python> <client-home>/.hermes/skills/unifi-network/scripts/unifi_network_client.py --help",
          "commands": [
            {
              "command": "<python> <client-home>/.hermes/skills/unifi-network/scripts/unifi_network_client.py --help",
              "exit_status": 0
            ...
            {
              "command": "<python> <client-home>/.hermes/skills/unifi-protect/scripts/unifi_protect_client.py --help",
              "exit_status": 0
            }
          ],
          "evidence": "Ran 2 command(s); exit status 0, 0. The client's output named the package name."
