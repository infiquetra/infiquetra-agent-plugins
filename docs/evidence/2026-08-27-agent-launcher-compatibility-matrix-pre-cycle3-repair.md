...
<!-- superseded-reason: Code-review cycle-2 repairs (fix-eddba59df99e) changed the portable skill bytes; the assessment was re-run and the record re-bound to the repaired fingerprint. The chain ends at a notice, which names the 2026-09-22 ten-client assessment of the authored version as the current matrix. -->
