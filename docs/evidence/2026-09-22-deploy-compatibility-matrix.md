...
# Ten-client compatibility matrix — portable deploy package (0.2.3)

This repository holds the portable source catalog for Infiquetra Agent Skills
and Agent Plugins. `plugins/deploy/` is authored and maintained
here. This document records what happened when the shipped package —
16 files, tree `b5f31f2b73d168de02981b105efe61869b3819dc7585fcfb336276ce282547d5` — was put in front
...
- **Isolation.** Each client was handed its own fresh copy of the shipped tree, at 16 files, fingerprinted before and after that client ran. Every copy was unchanged afterwards, so no client added a vendor artifact to the package. Nine clients ran against
...
| Client | Outcome |
|---|---|
| Claude Code | All four stages ran through this client and every command exited 0: placement, discovery, load, and invocation of 3 declared entrypoint(s) from the path this client resolved. |
...
| Cursor Agent | All four stages ran through this client and every command exited 0: placement, discovery, load, and invocation of 3 declared entrypoint(s) from the path this client resolved. |
| Qwen | All four stages ran through this client and every command exited 0: placement, discovery, load, and invocation of 3 declared entrypoint(s) from the path this client resolved. |
...
| Gemini CLI | All four stages ran through this client and every command exited 0: placement, discovery, load, and invocation of 3 declared entrypoint(s) from the path this client resolved. |
| Muse | All four stages ran through this client and every command exited 0: placement, discovery, load, and invocation of 3 declared entrypoint(s) from the path this client resolved. |
| Agy | All four stages ran through this client and every command exited 0: placement, discovery, load, and invocation of 3 declared entrypoint(s) from the path this client resolved. |
| Hermes | All four stages ran through this client and every command exited 0: placement, discovery, load, and invocation of 3 declared entrypoint(s) from the path this client resolved. |
...
```json
{
  ...
  "package": {
    ...
    "version": "0.2.3",
    "file_count": 16,
    "tree_sha256": "b5f31f2b73d168de02981b105efe61869b3819dc7585fcfb336276ce282547d5"
  },
  "method": {
    "stages": [
      "placement",
    ...
    "isolation": "Each client was handed its own fresh copy of the shipped tree, at 16 files, fingerprinted before and after that client ran. Every copy was unchanged afterwards, so no client added a vendor artifact to the package.",
    "credentials": "The harness removed every variable matching `GH_`, `GITHUB_` from every subprocess environment before each stage. Nine clients ran unauthenticated in their own empty scratch homes. Cursor Agent ran against the operator's real authenticated home by design, because an isolated home strips its authentication and produces a false failure; its authentication state is recorded only as present. No credential was created, changed, or read into this evidence, and no account identity is published here.",
    "network": "The invocation stage runs each declared entrypoint's credential-free `--help` action, which parses arguments and exits without a network call. The other three stages run each client's own commands, so a client that reaches its own service does so on its own account; Cursor Agent's three stages are model prompts, which is why it is the one client assessed against the real authenticated home."
  },
  "clients": [
    {
      ...
      "stages": {
        "placement": {
          ...
          "evidence": "Ran 1 command(s); exit status 0. The client's output named the package name, version 0.2.3, 0 of 1 declared skill unit(s)."
        },
        "discovery": {
          "result": "executed",
          "command": "claude --plugin-dir <package> plugin list",
        ...
        "load": {
          "result": "executed",
          "command": "claude --plugin-dir <package> plugin details deploy",
          "commands": [
            {
              "command": "claude --plugin-dir <package> plugin details deploy",
              "exit_status": 0
          ...
          "evidence": "Ran 1 command(s); exit status 0. The client's output named the package name, version 0.2.3, 1 of 1 declared skill unit(s)."
        },
        "invocation": {
          "result": "executed",
          "command": "<python> <package>/skills/deploy-state/scripts/mint_tag.py --help",
          "commands": [
            {
              "command": "<python> <package>/skills/deploy-state/scripts/mint_tag.py --help",
              "exit_status": 0
            ...
            {
              "command": "<python> <package>/skills/deploy-state/scripts/preview_release_notes.py --help",
              "exit_status": 0
            },
            {
              "command": "<python> <package>/skills/deploy-state/scripts/query_deployments.py --help",
              "exit_status": 0
            }
          ],
          "evidence": "Ran 3 command(s); exit status 0, 0, 0. The client's output named the package name."
        }
      },
      "status": "works-directly",
      "reason": "All four stages ran through this client and every command exited 0: placement, discovery, load, and invocation of 3 declared entrypoint(s) from the path this client resolved."
    },
    {
      "name": "OpenAI Codex",
      "version": "0.155.1",
      "stages": {
        "placement": {
          ...
          "evidence": "Ran 1 command(s); exit status 1. The client refused the package root and named the manifest it requires. The client's output named the package name, 0 of 1 declared skill unit(s)."
        },
        "discovery": {
          "result": "executed",
    ...
    },
    {
      ...
      "stages": {
        ...
        "invocation": {
          "result": "executed",
          "command": "<python> <client-home>/.qwen/extensions/deploy/skills/deploy-state/scripts/mint_tag.py --help",
          "commands": [
            {
              "command": "<python> <client-home>/.qwen/extensions/deploy/skills/deploy-state/scripts/mint_tag.py --help",
              "exit_status": 0
            ...
            {
              "command": "<python> <client-home>/.qwen/extensions/deploy/skills/deploy-state/scripts/preview_release_notes.py --help",
              "exit_status": 0
            },
            {
              "command": "<python> <client-home>/.qwen/extensions/deploy/skills/deploy-state/scripts/query_deployments.py --help",
              "exit_status": 0
            }
          ],
          "evidence": "Ran 3 command(s); exit status 0, 0, 0. The client's output named the package name."
    ...
    },
    {
      ...
      "stages": {
        "placement": {
          ...
          "evidence": "Ran 1 command(s); exit status 0. The client's output named the package name, 0 of 1 declared skill unit(s)."
        },
        "discovery": {
          "result": "executed",
        ...
        "load": {
          "result": "executed",
          "command": "grok plugin details deploy",
          "commands": [
            {
              "command": "grok plugin details deploy",
              "exit_status": 0
        ...
        "invocation": {
          "result": "blocked",
          "command": "<python> <client-home>/.grok/installed-plugins/<plugin-id>/skills/deploy-state/scripts/mint_tag.py --help",
    ...
    },
    {
      ...
      "stages": {
        "placement": {
          "result": "executed",
          "command": "cp -R <package>/skills/deploy-state <client-home>/.agents/skills/",
          "commands": [
            {
              "command": "cp -R <package>/skills/deploy-state <client-home>/.agents/skills/",
              "exit_status": 0
        ...
        "invocation": {
          "result": "executed",
          "command": "<python> <client-home>/.agents/skills/deploy-state/scripts/mint_tag.py --help",
          "commands": [
            {
              "command": "<python> <client-home>/.agents/skills/deploy-state/scripts/mint_tag.py --help",
              "exit_status": 0
            ...
            {
              "command": "<python> <client-home>/.agents/skills/deploy-state/scripts/preview_release_notes.py --help",
              "exit_status": 0
            },
            {
              "command": "<python> <client-home>/.agents/skills/deploy-state/scripts/query_deployments.py --help",
              "exit_status": 0
            }
          ],
          "evidence": "Ran 3 command(s); exit status 0, 0, 0. The client's output named the package name."
    ...
    },
    {
      ...
      "stages": {
        "placement": {
          "result": "executed",
          "command": "gemini skills link <package>/skills/deploy-state",
          "commands": [
            {
              "command": "gemini skills link <package>/skills/deploy-state",
              "exit_status": 0
        ...
        "invocation": {
          "result": "executed",
          "command": "<python> <client-home>/.gemini/skills/deploy-state/scripts/mint_tag.py --help",
          "commands": [
            {
              "command": "<python> <client-home>/.gemini/skills/deploy-state/scripts/mint_tag.py --help",
              "exit_status": 0
            ...
            {
              "command": "<python> <client-home>/.gemini/skills/deploy-state/scripts/preview_release_notes.py --help",
              "exit_status": 0
            },
            {
              "command": "<python> <client-home>/.gemini/skills/deploy-state/scripts/query_deployments.py --help",
              "exit_status": 0
            }
          ],
          "evidence": "Ran 3 command(s); exit status 0, 0, 0. The client's output named the package name."
    ...
    },
    {
      ...
      "stages": {
        "placement": {
          "result": "executed",
          "command": "muse skills install <package>/skills/deploy-state --scope user",
          "commands": [
            {
              "command": "muse skills install <package>/skills/deploy-state --scope user",
              "exit_status": 0
        ...
        "load": {
          "result": "executed",
          "command": "muse skills install <package>/skills/deploy-state --scope user --force --json",
          "commands": [
            {
              "command": "muse skills install <package>/skills/deploy-state --scope user --force --json",
              "exit_status": 0
        ...
        "invocation": {
          "result": "executed",
          "command": "<python> <client-home>/.config/muse/skills/deploy-state/scripts/mint_tag.py --help",
          "commands": [
            {
              "command": "<python> <client-home>/.config/muse/skills/deploy-state/scripts/mint_tag.py --help",
              "exit_status": 0
            ...
            {
              "command": "<python> <client-home>/.config/muse/skills/deploy-state/scripts/preview_release_notes.py --help",
              "exit_status": 0
            },
            {
              "command": "<python> <client-home>/.config/muse/skills/deploy-state/scripts/query_deployments.py --help",
              "exit_status": 0
            }
          ],
          "evidence": "Ran 3 command(s); exit status 0, 0, 0. The client's output named the package name."
    ...
    },
    {
      ...
      "stages": {
        ...
        "load": {
          "result": "executed",
          "command": "agy plugin validate <client-home>/.gemini/config/plugins/deploy",
          "commands": [
            {
              "command": "agy plugin validate <client-home>/.gemini/config/plugins/deploy",
              "exit_status": 0
        ...
        "invocation": {
          "result": "executed",
          "command": "<python> <client-home>/.gemini/config/plugins/deploy/skills/deploy-state/scripts/mint_tag.py --help",
          "commands": [
            {
              "command": "<python> <client-home>/.gemini/config/plugins/deploy/skills/deploy-state/scripts/mint_tag.py --help",
              "exit_status": 0
            ...
            {
              "command": "<python> <client-home>/.gemini/config/plugins/deploy/skills/deploy-state/scripts/preview_release_notes.py --help",
              "exit_status": 0
            },
            {
              "command": "<python> <client-home>/.gemini/config/plugins/deploy/skills/deploy-state/scripts/query_deployments.py --help",
              "exit_status": 0
            }
          ],
          "evidence": "Ran 3 command(s); exit status 0, 0, 0. The client's output named the package name."
    ...
    },
    {
      ...
      "stages": {
        "placement": {
          "result": "executed",
          "command": "cp -R <package>/skills/deploy-state <client-home>/.hermes/skills/",
          "commands": [
            {
              "command": "cp -R <package>/skills/deploy-state <client-home>/.hermes/skills/",
              "exit_status": 0
        ...
        "invocation": {
          "result": "executed",
          "command": "<python> <client-home>/.hermes/skills/deploy-state/scripts/mint_tag.py --help",
          "commands": [
            {
              "command": "<python> <client-home>/.hermes/skills/deploy-state/scripts/mint_tag.py --help",
              "exit_status": 0
            ...
            {
              "command": "<python> <client-home>/.hermes/skills/deploy-state/scripts/preview_release_notes.py --help",
              "exit_status": 0
            },
            {
              "command": "<python> <client-home>/.hermes/skills/deploy-state/scripts/query_deployments.py --help",
              "exit_status": 0
            }
          ],
          "evidence": "Ran 3 command(s); exit status 0, 0, 0. The client's output named the package name."
