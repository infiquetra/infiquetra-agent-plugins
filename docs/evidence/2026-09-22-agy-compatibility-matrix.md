...
and Agent Plugins. `plugins/agy/` is authored and maintained
here. This document records what happened when the shipped package —
34 files, tree `d93ab38bb52c2dd4040fb4de54140aac810f0bcf5affaeede551a46fb89ff28a` — was put in front
...
```json
{
  ...
  "package": {
    ...
    "version": "0.6.2",
    "file_count": 34,
    "tree_sha256": "d93ab38bb52c2dd4040fb4de54140aac810f0bcf5affaeede551a46fb89ff28a"
  },
  "method": {
    "stages": [
      "placement",
  ...
  "clients": [
    {
      ...
      "stages": {
        "placement": {
          ...
          "evidence": "Ran 1 command(s); exit status 0. The client's output named the package name, version 0.6.2, 0 of 1 declared skill unit(s)."
        },
        "discovery": {
          "result": "executed",
          "command": "claude --plugin-dir <package> plugin list",
        ...
        "load": {
          "result": "executed",
          "command": "claude --plugin-dir <package> plugin details agy",
          "commands": [
            {
              "command": "claude --plugin-dir <package> plugin details agy",
              "exit_status": 0
          ...
          "evidence": "Ran 1 command(s); exit status 0. The client's output named the package name, version 0.6.2, 1 of 1 declared skill unit(s)."
        },
        "invocation": {
          "result": "executed",
          "command": "<python> <package>/skills/agy-delegate/scripts/agy_delegate.py --help",
          "commands": [
            {
              "command": "<python> <package>/skills/agy-delegate/scripts/agy_delegate.py --help",
              "exit_status": 0
    ...
    },
    {
      ...
      "stages": {
        ...
        "invocation": {
          "result": "executed",
          "command": "<python> <client-home>/.qwen/extensions/agy/skills/agy-delegate/scripts/agy_delegate.py --help",
          "commands": [
            {
              "command": "<python> <client-home>/.qwen/extensions/agy/skills/agy-delegate/scripts/agy_delegate.py --help",
              "exit_status": 0
    ...
    },
    {
      ...
      "stages": {
        ...
        "load": {
          "result": "executed",
          "command": "grok plugin details agy",
          "commands": [
            {
              "command": "grok plugin details agy",
              "exit_status": 0
        ...
        "invocation": {
          "result": "blocked",
          "command": "<python> <client-home>/.grok/installed-plugins/<plugin-id>/skills/agy-delegate/scripts/agy_delegate.py --help",
    ...
    },
    {
      ...
      "stages": {
        "placement": {
          "result": "executed",
          "command": "cp -R <package>/skills/agy-delegate <client-home>/.agents/skills/",
          "commands": [
            {
              "command": "cp -R <package>/skills/agy-delegate <client-home>/.agents/skills/",
              "exit_status": 0
        ...
        "invocation": {
          "result": "executed",
          "command": "<python> <client-home>/.agents/skills/agy-delegate/scripts/agy_delegate.py --help",
          "commands": [
            {
              "command": "<python> <client-home>/.agents/skills/agy-delegate/scripts/agy_delegate.py --help",
              "exit_status": 0
    ...
    },
    {
      ...
      "stages": {
        "placement": {
          "result": "executed",
          "command": "gemini skills link <package>/skills/agy-delegate",
          "commands": [
            {
              "command": "gemini skills link <package>/skills/agy-delegate",
              "exit_status": 0
        ...
        "invocation": {
          "result": "executed",
          "command": "<python> <client-home>/.gemini/skills/agy-delegate/scripts/agy_delegate.py --help",
          "commands": [
            {
              "command": "<python> <client-home>/.gemini/skills/agy-delegate/scripts/agy_delegate.py --help",
              "exit_status": 0
    ...
    },
    {
      ...
      "stages": {
        "placement": {
          "result": "executed",
          "command": "muse skills install <package>/skills/agy-delegate --scope user",
          "commands": [
            {
              "command": "muse skills install <package>/skills/agy-delegate --scope user",
              "exit_status": 0
        ...
        "load": {
          "result": "executed",
          "command": "muse skills install <package>/skills/agy-delegate --scope user --force --json",
          "commands": [
            {
              "command": "muse skills install <package>/skills/agy-delegate --scope user --force --json",
              "exit_status": 0
        ...
        "invocation": {
          "result": "executed",
          "command": "<python> <client-home>/.config/muse/skills/agy-delegate/scripts/agy_delegate.py --help",
          "commands": [
            {
              "command": "<python> <client-home>/.config/muse/skills/agy-delegate/scripts/agy_delegate.py --help",
              "exit_status": 0
    ...
    },
    {
      ...
      "stages": {
        ...
        "load": {
          "result": "executed",
          "command": "agy plugin validate <client-home>/.gemini/config/plugins/agy",
          "commands": [
            {
              "command": "agy plugin validate <client-home>/.gemini/config/plugins/agy",
              "exit_status": 0
        ...
        "invocation": {
          "result": "executed",
          "command": "<python> <client-home>/.gemini/config/plugins/agy/skills/agy-delegate/scripts/agy_delegate.py --help",
          "commands": [
            {
              "command": "<python> <client-home>/.gemini/config/plugins/agy/skills/agy-delegate/scripts/agy_delegate.py --help",
              "exit_status": 0
    ...
    },
    {
      ...
      "stages": {
        "placement": {
          "result": "executed",
          "command": "cp -R <package>/skills/agy-delegate <client-home>/.hermes/skills/",
          "commands": [
            {
              "command": "cp -R <package>/skills/agy-delegate <client-home>/.hermes/skills/",
              "exit_status": 0
        ...
        "invocation": {
          "result": "executed",
          "command": "<python> <client-home>/.hermes/skills/agy-delegate/scripts/agy_delegate.py --help",
          "commands": [
            {
              "command": "<python> <client-home>/.hermes/skills/agy-delegate/scripts/agy_delegate.py --help",
              "exit_status": 0
