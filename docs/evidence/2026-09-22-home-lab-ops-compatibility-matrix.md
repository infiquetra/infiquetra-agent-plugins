...
# Ten-client compatibility matrix — portable home-lab-ops package (1.2.2)

This repository holds the portable source catalog for Infiquetra Agent Skills
and Agent Plugins. `plugins/home-lab-ops/` is authored and maintained
here. This document records what happened when the shipped package —
126 files, tree `a09331a19db3c9a7f5f9656a588c2eddced07d127400c1b6e43d6b7ed8c4c6c4` — was put in front
...
- **Isolation.** Each client was handed its own fresh copy of the shipped tree, at 126 files, fingerprinted before and after that client ran. Every copy was unchanged afterwards, so no client added a vendor artifact to the package. Nine clients ran against
...
```json
{
  ...
  "package": {
    ...
    "version": "1.2.2",
    "file_count": 126,
    "tree_sha256": "a09331a19db3c9a7f5f9656a588c2eddced07d127400c1b6e43d6b7ed8c4c6c4"
  },
  "method": {
    "stages": [
      "placement",
    ...
    "isolation": "Each client was handed its own fresh copy of the shipped tree, at 126 files, fingerprinted before and after that client ran. Every copy was unchanged afterwards, so no client added a vendor artifact to the package.",
    "credentials": "The package declares no credential variable, which its port descriptor states by naming `credential_prefixes` in `declared_none`, so there was nothing for the harness to strip. Nine clients ran unauthenticated in their own empty scratch homes. Cursor Agent ran against the operator's real authenticated home by design, because an isolated home strips its authentication and produces a false failure; its authentication state is recorded only as present. No credential was created, changed, or read into this evidence, and no account identity is published here.",
    "network": "The invocation stage runs each declared entrypoint's credential-free `--help` action, which parses arguments and exits without a network call. The other three stages run each client's own commands, so a client that reaches its own service does so on its own account; Cursor Agent's three stages are model prompts, which is why it is the one client assessed against the real authenticated home."
  },
  "clients": [
    {
      ...
      "stages": {
        "placement": {
          ...
          "evidence": "Ran 1 command(s); exit status 0. The client's output named the package name, version 1.2.2, 0 of 6 declared skill unit(s)."
        },
        "discovery": {
          "result": "executed",
          "command": "claude --plugin-dir <package> plugin list",
        ...
        "load": {
          "result": "executed",
          "command": "claude --plugin-dir <package> plugin details home-lab-ops",
          "commands": [
            {
              "command": "claude --plugin-dir <package> plugin details home-lab-ops",
              "exit_status": 0
          ...
          "evidence": "Ran 1 command(s); exit status 0. The client's output named the package name, version 1.2.2, 6 of 6 declared skill unit(s)."
        },
        "invocation": {
          "result": "executed",
          "command": "<python> <package>/skills/team-scaffold/scripts/team-scaffold --help",
          "commands": [
            {
              "command": "<python> <package>/skills/team-scaffold/scripts/team-scaffold --help",
              "exit_status": 0
          ...
          "evidence": "Ran 1 command(s); exit status 0. The client's output named neither the package nor a declared unit."
        }
      },
    ...
    },
    {
      ...
      "stages": {
        "placement": {
          ...
          "evidence": "Ran 1 command(s); exit status 1. The client refused the package root and named the manifest it requires. The client's output named the package name, 0 of 6 declared skill unit(s)."
        },
        "discovery": {
          "result": "executed",
          ...
          "evidence": "Ran 1 command(s); exit status 0. The client's output named 0 of 6 declared skill unit(s)."
        },
        "load": {
          "result": "blocked",
    ...
    },
    {
      ...
      "stages": {
        ...
        "load": {
          ...
          "evidence": "Ran 1 command(s); exit status 0. The client's output named the package name, 6 of 6 declared skill unit(s)."
        },
        "invocation": {
          "result": "executed",
          "command": "<python> <package>/skills/team-scaffold/scripts/team-scaffold --help",
    ...
    },
    {
      ...
      "stages": {
        ...
        "invocation": {
          "result": "executed",
          "command": "<python> <client-home>/.qwen/extensions/home-lab-ops/skills/team-scaffold/scripts/team-scaffold --help",
          "commands": [
            {
              "command": "<python> <client-home>/.qwen/extensions/home-lab-ops/skills/team-scaffold/scripts/team-scaffold --help",
              "exit_status": 0
    ...
    },
    {
      ...
      "stages": {
        "placement": {
          ...
          "evidence": "Ran 1 command(s); exit status 0. The client's output named the package name, 0 of 6 declared skill unit(s)."
        },
        "discovery": {
          "result": "executed",
        ...
        "load": {
          "result": "executed",
          "command": "grok plugin details home-lab-ops",
          "commands": [
            {
              "command": "grok plugin details home-lab-ops",
              "exit_status": 0
        ...
        "invocation": {
          "result": "blocked",
          "command": "<python> <client-home>/.grok/installed-plugins/<plugin-id>/skills/team-scaffold/scripts/team-scaffold --help",
    ...
    },
    {
      ...
      "stages": {
        "placement": {
          "result": "executed",
          "command": "cp -R <package>/skills/ansible-preflight <client-home>/.agents/skills/",
          "commands": [
            {
              "command": "cp -R <package>/skills/ansible-preflight <client-home>/.agents/skills/",
              "exit_status": 0
            ...
            {
              "command": "cp -R <package>/skills/inventory-sync <client-home>/.agents/skills/",
              "exit_status": 0
            },
            {
              "command": "cp -R <package>/skills/monitoring-guard <client-home>/.agents/skills/",
              "exit_status": 0
            },
            {
              "command": "cp -R <package>/skills/proxmox-operations <client-home>/.agents/skills/",
              "exit_status": 0
            },
            {
              "command": "cp -R <package>/skills/team-scaffold <client-home>/.agents/skills/",
              "exit_status": 0
            },
            {
              "command": "cp -R <package>/skills/vault-helper <client-home>/.agents/skills/",
              "exit_status": 0
            }
          ],
          "evidence": "Ran 6 command(s); exit status 0, 0, 0, 0, 0, 0. The command produced no output, so its exit status is the whole result."
        },
        "discovery": {
          "result": "executed",
          ...
          "evidence": "Ran 1 command(s); exit status 1. The client reported the subcommand this stage uses as unknown. The client's output named 0 of 6 declared skill unit(s)."
        },
        "load": {
          "result": "executed",
          "command": "opencode debug skill",
        ...
        "invocation": {
          "result": "executed",
          "command": "<python> <client-home>/.agents/skills/team-scaffold/scripts/team-scaffold --help",
          "commands": [
            {
              "command": "<python> <client-home>/.agents/skills/team-scaffold/scripts/team-scaffold --help",
              "exit_status": 0
    ...
    },
    {
      ...
      "stages": {
        "placement": {
          "result": "executed",
          "command": "gemini skills link <package>/skills/ansible-preflight",
          "commands": [
            {
              "command": "gemini skills link <package>/skills/ansible-preflight",
              "exit_status": 0
            ...
            {
              "command": "gemini skills link <package>/skills/inventory-sync",
              "exit_status": 0
            },
            {
              "command": "gemini skills link <package>/skills/monitoring-guard",
              "exit_status": 0
            },
            {
              "command": "gemini skills link <package>/skills/proxmox-operations",
              "exit_status": 0
            },
            {
              "command": "gemini skills link <package>/skills/team-scaffold",
              "exit_status": 0
            },
            {
              "command": "gemini skills link <package>/skills/vault-helper",
              "exit_status": 0
            }
          ],
          "evidence": "Ran 6 command(s); exit status 0, 0, 0, 0, 0, 0. The client's output named the package name, 6 of 6 declared skill unit(s)."
        },
        "discovery": {
          "result": "executed",
        ...
        "invocation": {
          "result": "executed",
          "command": "<python> <client-home>/.gemini/skills/team-scaffold/scripts/team-scaffold --help",
          "commands": [
            {
              "command": "<python> <client-home>/.gemini/skills/team-scaffold/scripts/team-scaffold --help",
              "exit_status": 0
    ...
    },
    {
      ...
      "stages": {
        "placement": {
          "result": "executed",
          "command": "muse skills install <package>/skills/ansible-preflight --scope user",
          "commands": [
            {
              "command": "muse skills install <package>/skills/ansible-preflight --scope user",
              "exit_status": 0
            ...
            {
              "command": "muse skills install <package>/skills/inventory-sync --scope user",
              "exit_status": 0
            },
            {
              "command": "muse skills install <package>/skills/monitoring-guard --scope user",
              "exit_status": 0
            },
            {
              "command": "muse skills install <package>/skills/proxmox-operations --scope user",
              "exit_status": 0
            },
            {
              "command": "muse skills install <package>/skills/team-scaffold --scope user",
              "exit_status": 0
            },
            {
              "command": "muse skills install <package>/skills/vault-helper --scope user",
              "exit_status": 0
            }
          ],
          "evidence": "Ran 6 command(s); exit status 0, 0, 0, 0, 0, 0. The client's output named 6 of 6 declared skill unit(s)."
        },
        "discovery": {
          "result": "executed",
          ...
          "evidence": "Ran 1 command(s); exit status 0. The client's output named 6 of 6 declared skill unit(s)."
        },
        "load": {
          "result": "executed",
          "command": "muse skills install <package>/skills/ansible-preflight --scope user --force --json",
          "commands": [
            {
              "command": "muse skills install <package>/skills/ansible-preflight --scope user --force --json",
              "exit_status": 0
            ...
            {
              "command": "muse skills install <package>/skills/inventory-sync --scope user --force --json",
              "exit_status": 0
            },
            {
              "command": "muse skills install <package>/skills/monitoring-guard --scope user --force --json",
              "exit_status": 0
            },
            {
              "command": "muse skills install <package>/skills/proxmox-operations --scope user --force --json",
              "exit_status": 0
            },
            {
              "command": "muse skills install <package>/skills/team-scaffold --scope user --force --json",
              "exit_status": 0
            },
            {
              "command": "muse skills install <package>/skills/vault-helper --scope user --force --json",
              "exit_status": 0
            }
          ],
          "evidence": "Ran 6 command(s); exit status 0, 0, 0, 0, 0, 0. The client's output named 6 of 6 declared skill unit(s)."
        ...
        "invocation": {
          "result": "executed",
          "command": "<python> <client-home>/.config/muse/skills/team-scaffold/scripts/team-scaffold --help",
          "commands": [
            {
              "command": "<python> <client-home>/.config/muse/skills/team-scaffold/scripts/team-scaffold --help",
              "exit_status": 0
    ...
    },
    {
      ...
      "stages": {
        ...
        "load": {
          "result": "executed",
          "command": "agy plugin validate <client-home>/.gemini/config/plugins/home-lab-ops",
          "commands": [
            {
              "command": "agy plugin validate <client-home>/.gemini/config/plugins/home-lab-ops",
              "exit_status": 0
        ...
        "invocation": {
          "result": "executed",
          "command": "<python> <client-home>/.gemini/config/plugins/home-lab-ops/skills/team-scaffold/scripts/team-scaffold --help",
          "commands": [
            {
              "command": "<python> <client-home>/.gemini/config/plugins/home-lab-ops/skills/team-scaffold/scripts/team-scaffold --help",
              "exit_status": 0
    ...
    },
    {
      ...
      "stages": {
        "placement": {
          "result": "executed",
          "command": "cp -R <package>/skills/ansible-preflight <client-home>/.hermes/skills/",
          "commands": [
            {
              "command": "cp -R <package>/skills/ansible-preflight <client-home>/.hermes/skills/",
              "exit_status": 0
            ...
            {
              "command": "cp -R <package>/skills/inventory-sync <client-home>/.hermes/skills/",
              "exit_status": 0
            },
            {
              "command": "cp -R <package>/skills/monitoring-guard <client-home>/.hermes/skills/",
              "exit_status": 0
            },
            {
              "command": "cp -R <package>/skills/proxmox-operations <client-home>/.hermes/skills/",
              "exit_status": 0
            },
            {
              "command": "cp -R <package>/skills/team-scaffold <client-home>/.hermes/skills/",
              "exit_status": 0
            },
            {
              "command": "cp -R <package>/skills/vault-helper <client-home>/.hermes/skills/",
              "exit_status": 0
            }
          ],
          "evidence": "Ran 6 command(s); exit status 0, 0, 0, 0, 0, 0. The command produced no output, so its exit status is the whole result."
        ...
        "invocation": {
          "result": "executed",
          "command": "<python> <client-home>/.hermes/skills/team-scaffold/scripts/team-scaffold --help",
          "commands": [
            {
              "command": "<python> <client-home>/.hermes/skills/team-scaffold/scripts/team-scaffold --help",
              "exit_status": 0
