...
- Invoke `python3 "${CLAUDE_PLUGIN_ROOT}/scripts/codex_delegate.py"` exactly once per delegated turn.
...
3. Run `python3 "${CLAUDE_PLUGIN_ROOT}/scripts/codex_delegate.py"` exactly once with that envelope or task
   file.
