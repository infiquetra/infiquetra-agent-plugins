...
```bash
cd "${HOME_LAB_ROOT:-$HOME/home-lab}/ansible"
```

`HOME_LAB_ROOT` is the private infrastructure checkout. It defaults to
`~/home-lab`. Set it when that checkout lives somewhere else.
